      ...
      const updatedWeatherData = {
        ...
        hourly: fetchedWeatherData.hourly.time.map((timestamp, index) => ({
          ...
          visibility: Math.round(
            fetchedWeatherData.hourly.visibility[index] / 5280,
          ),
          precipitationProbability:
            fetchedWeatherData.hourly.precipitation_probability[index],
        })),
        hourly_units: {
          ...
          visibility: "miles",
          precipitationProbability:
            fetchedWeatherData.hourly_units.precipitation_probability,
        },
      };
