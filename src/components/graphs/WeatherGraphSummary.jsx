  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.description}>
        The {name} graph produces a {graph} graph. This graph contains {data.hourly.length} items, which produced 
        a max value of {maxValue}{data.hourly_units[graph]}, a min value of {minValue}{data.hourly_units[graph]}, and an average value of {avgVal}{data.hourly_units[graph]}.
      </p>
    </div>
  )
}