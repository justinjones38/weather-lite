...
export default function DashboardAuthenticator() {
  ...
  if(!data && !loading || error) {
    return <Navigate to="/" state={{message: "Please enter a valid city before viewing dashboard"}} />
  }
  return (
    <Outlet context={{data, loading, error, filteredResults, setFilteredResults }} />
  )
}