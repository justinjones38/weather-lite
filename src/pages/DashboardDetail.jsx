  ...
  if (!weatherData) {
    return (
      <Navigate
        to="/"
        state={{
          message: "Please enter a valid city to view dashboard details",
        }}
      />
    );
  }
    ...
    <div className={styles.container}>
      ...
      <div className={styles.contentWrapper}>
        ...
        <p className={styles.item}>
          Wind Speed:{" "}
          <span>
            {weatherData.windSpeed} {data.hourly_units.windSpeed}
          </span>
        </p>
        ...
        <p className={styles.item}>
          Visibility:{" "}
          <span>
            {weatherData.visibility} {data.hourly_units.visibility}
          </span>
        </p>
        ...
        <p className={styles.item}>
          ...
          <span>
            ...
            {data.hourly_units.precipitationProbability}
          </span>
        </p>
      </div>
    </div>
